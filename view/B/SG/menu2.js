...
<script>\
    document.addEventListener("DOMContentLoaded", function(){\
        ...
        if(memberEmail == null || memberEmail == "") {\
            ...
            document.getElementById("favouritesMenuLink").setAttribute("style", "display:none");\
        }\
        else {\
            ...
            document.getElementById("favouritesMenuLink").setAttribute("href", "/B/' + countryPrefix + '/favouriteMenu.html?cat=" + encodeURIComponent("Favourite Menu"));\
        }\
        ...
        <div id="menuLoggedOut" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li class="services">\
                        <a href="/B/' + countryPrefix + '/services.html">\
                            <i class="icon icon-cogs"></i>Services\
                        </a>\
                    </li>\
                    <li>\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li>\
                        <a id="favouritesMenuLink"><i class="icon icon-heart"></i>Favourites Menu</a>\
                    </li>\
                    <li class="dropdown">\
...
// <li><a id="guidanceLink"><i class="icon icon-wrench"></i>Guidance Service</a></li>\